    ...
    return (
        <form action="" className='bg-white m-1 p-1.5 grid grid-cols-1 md:grid-cols-2 pb-5 '>
            <div className="md:mr-2 mb-5">
                ...
                <input list="cities" name="source" aria-required='true' placeholder='Source City' className='w-full m rounded-md border-2 text-gray-600 pl-2' />
                <datalist id="cities">
            ...
            <div className="md:ml-2 mb-5">
                ...
                <input list="cities" name="destination" aria-required='true' placeholder='Destination City' className='w-full rounded-md border-2 text-gray-600 pl-2' />
            ...
            <div className="md:mr-2 mb-5">
                ...
                <select id="material" name="material" aria-required='true' className='w-full bg-transparent rounded-md border-2 text-gray-600 pl-2'>
            ...
            <div className="md:ml-2 mb-5">
                ...
                <select id="weight" name="weight" aria-required='true' className='w-full bg-transparent rounded-md border-2 text-gray-600 pl-2'>
                    <option value="select" selected>Select</option>
            ...
            <div className="mr-2 mb-5">
                ...
                <select id="truck" name="truck" aria-required='true' className='w-full bg-transparent rounded-md border-2 text-gray-600 pl-2'>
                    <option value="select" selected>Select</option>
            ...
            <div className="md:ml-2 mb-5">
                ...
                <input type="number" id="truck" min={1} placeholder='No. of Trucks required' className=' w-full bg-transparent rounded-md border-2 text-gray-600 pl-2' />
            </div>

            <div className="md:mr-2 md:mb-5">
                <label htmlFor="pickupdate">Pickup Date<span className='text-red-500 space-y-1'>*</span></label><br />
                <input type="datetime-local" id="pickupdate" placeholder='No. of Trucks required' className='bg-transparent w-full rounded-md border-2 text-gray-600 pl-2' />
            </div>

            <div className="md:ml-auto md:mr-auto">
                <br />
                <button type="submit" className="bg-orange-400 rounded-md w-[6rem] p-1  mr-auto ml-auto  md:mt-0 text-white active:scale-95 transition transform duration-100">Submit
                </button>
            </div>
